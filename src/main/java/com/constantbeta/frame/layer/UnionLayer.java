...
public class UnionLayer extends MaskLayerBase
{
    private final MaskLayer[] maskLayers;

    public UnionLayer(int width, int height, MaskLayer[] maskLayers)
    {
        super(width, height);
    ...
    public UnionLayer(int width, int height, JSONObject config)
    {
